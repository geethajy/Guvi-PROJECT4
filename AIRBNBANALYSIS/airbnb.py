...
with col1:
        image1 = Image.open(r"D:\AIRBNBANALYSIS\OIP.jpg")
        st.image(image1, width=300)
        
with col2:
    col2.subheader("NAME : GEETHA")
    col2.subheader("EMAIL: geethabscb@gmail.com")
    col2.subheader("BATCH : MDE86")
